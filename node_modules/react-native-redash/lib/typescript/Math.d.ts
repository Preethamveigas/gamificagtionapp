...
export declare const clamp: (value: Animated.Node<number>, lowerBound: number, upperBound: number) => Animated.Node<number>;
export declare const atan: (rad: Animated.Adaptable<number>) => Animated.Node<number>;
